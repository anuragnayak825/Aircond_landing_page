...
export default function CTABanner() {
    return (
        <div
            className="w-full h-auto bg-gradient-to-r from-gray-100/70 to-blue-50/70 py-10 px-4 text-center "
            style={{
        ...
        >
            <h2 className="text-xl sm:text-3xl font-bold text-black drop-shadow">
                Need Aircon Service? We’re Just a Call Away!
            </h2>
            <p className="mt-2 text-black font-medium max-w-3xl text-lg md:text-xl italic tracking-wide mx-auto drop-shadow">
