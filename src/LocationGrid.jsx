...
const LocationGrid = () => {
  ...
  return (
    <div id="location" className="px-6 py-10 bg-gray-50">
      ...
      <p className="text-lg font-semibold italicssr mb-10 italicss text-center">We're just around the corner — check out where we operate!</p>
      ...
      <div className="text-center">
        <button onClick={() => window.location.href = "https://wa.me/60163824522"} className="px-3 w-auto py-2 bg-yellow-400 font-semibold text-lg italicssr italicss shadow-md shadow-yellow-900 rounded-md"> More Location</button>
      </div>
    </div>
  );
};
