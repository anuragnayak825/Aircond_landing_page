...
export default function LandingPage() {
  return (
    <>
      ...
      <HeroSection />
      <CoolTechSection />
      <div className="w-full h-auto px-4 py-12">
        <div className="w-full max-w-6xl mx-auto bg-gradient-to-r from-[#1f295e] via-[#3c5a9a] to-[#2aa8d8] hover:scale-[1.010] transition  text-white p-6 md:p-10 rounded-2xl shadow-xl flex flex-col md:flex-row items-center justify-between gap-6 md:gap-4">
